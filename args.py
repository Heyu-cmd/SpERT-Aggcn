...
def _add_common_args(arg_parser):
    ...
    # aggcn
    arg_parser.add_argument('--in_dim', type=int, default=768, help="aggcn model input dim")
    arg_parser.add_argument('--hidden_dim', type=int, default=768, help="model hidden dim")
    arg_parser.add_argument('--input_dropout', type=float, default=0.5, help="aggcn model input dropout")
    arg_parser.add_argument('--num_layers', type=int, default=2)
    arg_parser.add_argument('--heads', type=int, default=3, help="attention head nums")
    arg_parser.add_argument('--sublayer_first', type=int, default=2, help="aggcn first layers num")
    arg_parser.add_argument('--sublayer_second', type=int, default=4, help="aggcn second layers num")
    arg_parser.add_argument('--gcn_dropout', type=float, default=0.3, help="GCN layer dropout rate")
    ## if use ner-adj  or rc-adj
    arg_parser.add_argument('--adj_ner', action="store_true", default=True, help="If ner use gcn")
    arg_parser.add_argument('--adj_rc', action="store_true", default=True, help="If rc use gcn")
